    ...
    <button class="btn btn-primary btn-sm" onclick="location.href='<?php echo $link; ?><?php echo $link_form; ?>'">Back</button>
        ...
        <div class="box-body">   
            ...
            <div class="col-md-6">
                ...
                <input type="hidden" name="article_alias" id="article_alias" class="form-control required" value="<?php echo isset($data['article_alias'])  ? $data['article_alias'] : "" ?>">
                <!--<div class="form-group">
